...
console.log('three:', three);// three: 3
```
> 事实上,只要某种数据结构具有Iterator接口,都可以采用数组形式的解构赋值,参见《Generator 函数》
...
console.log('name === Number.prototype.toString()', name === Number.prototype.toString());// name === Number.prototype.toString() false
console.log('name === Number.prototype.toString', name === Number.prototype.toString);// name === Number.prototype.toString true

let {toString: bool} = true;
console.log('bool === Number.prototype.toString()', bool === Boolean.prototype.toString());// bool === Boolean.prototype.toString() false
console.log('bool === Number.prototype.toString', bool === Boolean.prototype.toString);// bool === Boolean.prototype.toString true
```
